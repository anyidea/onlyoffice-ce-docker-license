...
RUN apt-get update && apt-get install -y ${build_deps} && \
    ...
    echo "deb [signed-by=/usr/share/keyrings/nodesource-archive-keyring.gpg] https://deb.nodesource.com/node_18.x $(lsb_release -c -s) main" | tee /etc/apt/sources.list.d/nodesource.list && \
